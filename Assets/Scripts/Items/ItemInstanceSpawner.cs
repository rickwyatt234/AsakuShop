...
public static class ItemInstanceSpawner
{
    ...
    public static GameObject SpawnItemInstance(string itemID, Vector3 position, Quaternion rotation)
    {
        ItemDefinition definition = ItemRegistry.Instance.Get(itemID);
    ...
    public static GameObject SpawnItemInstance(string itemID, ItemGrade grade, Vector3 position, Quaternion rotation)
    {
        ItemDefinition definition = ItemRegistry.Instance.Get(itemID);
        if (definition == null || definition.WorldPrefab == null)
        {
    ...
    public static GameObject SpawnItemInstance(string itemID, ItemGrade grade, float currentPrice, Vector3 position, Quaternion rotation)
    {
        ItemDefinition definition = ItemRegistry.Instance.Get(itemID);
        if (definition == null || definition.WorldPrefab == null)
        {
